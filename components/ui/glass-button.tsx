...
export function GlassButton({
  ...
  return (
    <motion.a
      ...
      className={cn(
        "glass-pill glass-pill-interactive relative inline-flex min-h-11 items-center justify-center gap-2 px-4 text-sm font-medium text-neutral-100 transition-[border-color,background-color,box-shadow] duration-200 hover:border-white/30 hover:bg-white/[0.1] hover:shadow-[0_0_0_1px_rgba(195,244,255,.18),0_10px_30px_-8px_rgba(30,111,255,.45)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#B497CF] focus-visible:ring-offset-2 focus-visible:ring-offset-black active:duration-75",
