    ...
    <html lang="en">
      <head>
        ...
        <meta
          ...
          content="default-src 'self'; base-uri 'self'; object-src 'none'; script-src 'self' 'unsafe-inline' 'wasm-unsafe-eval'; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com data:; img-src 'self' data: blob: https:; connect-src 'self' https://ipwho.is https://ipapi.co https://prod.spline.design https://*.spline.design https://unpkg.com; worker-src 'self' blob:; media-src 'self' data: blob:; form-action 'self'"
        />
